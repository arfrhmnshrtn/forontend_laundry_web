      ...
      <div class="bg-white rounded-lg shadow">
        ...
        <div v-else class="overflow-x-auto">
              ...
              >
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    ...
                    <div class="ml-3">
                      <p class="text-sm font-medium text-gray-900">{{ customer.nama }}</p>
                    </div>
                  </div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ customer.no_telp }}</td>
          ...
          <EmptyState
            ...
            :description="searchQuery ? 'Coba kata kunci pencarian lain' : 'Mulai dengan menambahkan pelanggan baru'"
          />
        </div>
      </div>
    </div>
      ...
      <form @submit.prevent="handleSave" class="space-y-4">
        ...
        <div class="flex gap-3 pt-4">
          <button
            ...
            class="flex-1 px-4 py-2 border text-gray-700 rounded-lg hover:bg-gray-50"
          >
            Batal
          </button>
          <button
